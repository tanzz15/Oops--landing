...
const lines = [
  ...
  '            </a>',
  '            <a',
  '              href="https://youtu.be/_2k65MiL63o"',
  '              target="_blank"',
  '              rel="noopener noreferrer"',
  ...
  '            <iframe',
  '              src="https://www.youtube.com/embed/_2k65MiL63o?autoplay=1&mute=1&loop=1&playlist=_2k65MiL63o"',
  '              width={520}',
  '              height={292}',
...
fs.writeFileSync('d:/SEMESTER 6/Game/FP/Lp/components/hero.tsx', content, 'utf8');
console.log('Written successfully -', lines.length, 'lines,', content.length, 'chars');
